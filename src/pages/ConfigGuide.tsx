  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 max-w-3xl mx-auto">
      ...
      <p className="text-lg text-zinc-400 mb-8">
        Configure Vivido, vvmux, and companion tools with TOML.
      </p>
      ...
      <div className="border border-dashed border-zinc-700 rounded-xl p-8 text-center">
        ...
        <p className="text-zinc-500 max-w-md mx-auto">
          A complete configuration reference covering vivido.toml, vvmux config.toml, color schemes,
          key bindings, and font settings is in progress.
        </p>
      </div>
    </div>
  )
